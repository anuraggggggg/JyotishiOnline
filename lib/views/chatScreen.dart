          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () async {
                ...
                // try {
                //   final response = await _apiService.chatWithAstrologer(
                //     astro['astro_id'].toString(),
                //     "Hello, I’d like to chat.",
                //   );
                //
                //   if (!mounted) return;
                //
                ...
                //     SnackBar(
                //       content: Text(
                //           "Chat started with ${astro['name']} (ID: ${response['chatId'] ?? ''})"),
                //     ),
                //   );
                //
                //   // TODO: Navigate to actual chat conversation screen
                // } catch (e) {
                //   ScaffoldMessenger.of(context).showSnackBar(
        ...
        builder: (context, snapshot) {
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              itemCount: _allAstrologers.length,
              itemBuilder: (context, index) {
...
//                     child: Row(
//                       children: [
//                         Image.asset("assets/images/wallet1.png", height: 20, width: 20,),
//                         SizedBox(
//                             width :8
//                         ),
//                         Padding(
...
//                     size: 15, color: Colors.black //Get.theme.iconTheme.color,
//                     ),
//               ),
//             ),
//             GestureDetector(
