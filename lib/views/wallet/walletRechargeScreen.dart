...
class _RechargeWalletScreenState extends State<RechargeWalletScreen> {
  ...
  final List<double> usdAmounts = [5, 10, 15, 20, 25, 30];
  ...
  void _openCheckout() {
    ...
    bool isIndian = LocationService.isIndianUser;

    int payableAmount;

    if (isIndian) {
      payableAmount = (totalAmount * 100).toInt();
    } else {
      payableAmount = (totalAmount * 100).toInt(); // USD cents
    }
    ...
    var options = {
      ...
      'name': 'Jyotishi Online Wallet Recharge',
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Wallet update failed")),
      );
    }
  }
                ...
                children: [
                  ...
                  TextField(
                    ...
                    onChanged: (v) {
                      ...
                      setState(() {
                        _selectedAmount = int.tryParse(v);
                      });
                    },
                  ),
